...
public class EnemyOne : MonoBehaviour
{
    ...
    private void GetBadDirections()
    {
        ...
        {
            RaycastHit hit;
            if(Physics.Raycast(new Vector3(transform.position.x, transform.position.y + 0.5f, transform.position.z), Directions.directions[a] * avoidanceDetectionRange, out hit))
            {
